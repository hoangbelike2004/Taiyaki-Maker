...
{
    public const string KEY_DATA_GAME_SETTING = "Data/GameSetting";
    ...
    public const string ANIMATION_SKELETON_IDLE_1 = "idle1";

    public const string ANIMATION_SKELETON_EAT_1_1 = "idle2";

    public const string ANIMATION_SKELETON_EAT_1_2 = "idle3";

    public const string ANIMATION_SKELETON_CRAVE_1 = "idle4";
}
